...
opening3 = cv2.morphologyEx(thresh, cv2.MORPH_CLOSE,kernal, iterations =1)

cv2.namedWindow("opening3", cv2.WINDOW_NORMAL)
...
imgSize = opening2.size
nonBlack = cv2.countNonZero(opening2)
...
strHoles = "I count " + str(holes) + " holes."
print(strHoles)
